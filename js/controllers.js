...
function DashboardController($scope, Container, Engine) {
    Container.query({}, function (d) {
        $scope.containers = d;
    });

    Engine.query({}, function (d) {
        $scope.engines = d;
    });
}

function SettingsController($scope, System, Docker, Settings) {
    $scope.info = {};
    $scope.docker = {};
    ...
    Image.get({
        ...
        if (t && t !== ":") {
            ...
            promise.then(function (containers) {
                newLineChart('#containers-started-chart', containers, function (c) {
